...
if __name__ == "__main__":
    ...
    train_annotation_path = '/home/public/IRDST/coco_train_IRDST.txt'
    val_annotation_path = '/home/public/IRDST/coco_val_IRDST.txt' 
    ...
    model = MoPKL(num_classes=1,  num_frame=5) 
    weights_init(model)
    if model_path != '':
